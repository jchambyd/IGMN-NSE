...
public class ChiSquareUtils {
    ...
    /**
     * Returns the rates that should be used for a set number of rate categories and
     * a set value of alpha as per the methodology of Yang 1993
     *
    ...
    /**
     * Returns the inverse chi-squared distribution. Uses the method given in Best
     * and Roberts 1975. Makes calls to private functions using the methods of
     * Bhattacharjee 1970 and Odeh and Evans 1974. All converted to Java by the
     * author (yes, the author knows FORTRAN!)
     *
     * @param p The p-value
