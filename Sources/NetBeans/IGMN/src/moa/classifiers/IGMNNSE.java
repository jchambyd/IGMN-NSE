...
public class IGMNNSE extends AbstractClassifier implements MultiClassClassifier
{
    ...
    public FloatOption tau = new FloatOption("tau", 't',
            "Percentile of a chi-squared distribution.", 0.001,
            0.0001, 1.00);

    public FloatOption delta = new FloatOption("delta", 'd',
            "Initial size of covariance matrix.", 0.5,
            0.005, 0.99);
    
    public FloatOption gamma = new FloatOption("gamma", 'g',
            "Fraccion to be reset posteriori accumulators.", 0.5,
            0.01, 0.99);
    ...
    public double[] getVotesForInstance(Instance instance)
    {
        ...
        if (this.neurons == null) {
            ...
            SimpleMatrix clasify = this.recall(this.instanceToMatrix(instance).extractMatrix(0, instance.numInputAttributes(), 0, SimpleMatrix.END));
